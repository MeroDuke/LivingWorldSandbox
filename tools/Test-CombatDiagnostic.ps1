...
$requiredHookPatterns = @(
    ...
    '\$SpawnUnit\s*\(\s*Paladin\s*,\s*"LWS_Test_U_Long_T3P1"[^;]+"Override"[^;]+\$MakeInventoryAttribute\s*\(\s*"LWS_Test_U_Long_T3P1"',
    '\$SpawnUnit\s*\(\s*Paladin\s*,\s*"LWS_Test_R_Plate_T3P1"[^;]+"Override"[^;]+\$MakeInventoryAttribute\s*\(\s*"LWS_Test_R_Plate_T3P1"',
