...
$requiredHookPatterns = @(
    ...
    '\$SpawnUnit\s*\(\s*Paladin\s*,\s*"LWSDW_U_Longsword_3_1"[^;]+"Override"[^;]+\$MakeInventoryAttribute\s*\(\s*"LWSDW_U_Longsword_3_1"',
    '\$SpawnUnit\s*\(\s*Paladin\s*,\s*"LWSDA_R_Plate_3_1"[^;]+"Override"[^;]+\$MakeInventoryAttribute\s*\(\s*"LWSDA_R_Plate_3_1"',
